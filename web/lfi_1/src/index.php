                    ...
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-md-5 d-none d-md-block">
                                <img src="load.php?file=a.jpg" alt="login form" class="img-fluid h-100" style="object-fit: cover; object-position: left;">
                            </div>
                            <div class="col-md-7">
                                <div class="card-body p-5">
                                    <h2 class="text-center mb-5">脆 (活網版threads)</h2>
                                    <h5 class="text-center mb-4 text-danger">[BETA] 僅限管理員登入測試</h5>
                                    ...
                                    <form method="POST">
                                        ...
                                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                            ...
                                            if ($_POST["username"] == $secret['username'] && $_POST["password"] == $secret['password']) {
